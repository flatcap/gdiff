...
cb_create_tree (GtkWidget * w)
{
	...
	else if (GTK_TOGGLE_BUTTON (sTreeSampleSelection.browse_button)->active)
...
void 
clist_remove_selection (GtkWidget * widget, GtkCList * clist)
{
...
void 
toggle_title_buttons (GtkWidget * widget, GtkCList * clist)
{
...
void 
toggle_reorderable (GtkWidget * widget, GtkCList * clist)
{
...
void 
after_press (GtkCTree * ctree, gpointer data)
{
	char            buf[80];
...
void 
count_items (GtkCTree * ctree, GtkCTreeNode * list)
{
...
void 
expand_all (GtkWidget * widget, GtkCTree * ctree)
{
...
void 
collapse_all (GtkWidget * widget, GtkCTree * ctree)
{
...
void 
select_all (GtkWidget * widget, GtkCTree * ctree)
{
...
void 
change_style (GtkWidget * widget, GtkCTree * ctree)
{
	static GtkStyle *style1 = NULL;
	static GtkStyle *style2 = NULL;
...
void 
unselect_all (GtkWidget * widget, GtkCTree * ctree)
{
...
void 
export_ctree (GtkWidget * widget, GtkCTree * ctree)
{
	char           *title[] =
	{"Tree", "Info"};
...
void 
change_indent (GtkWidget * widget, GtkCTree * ctree)
{
	gtk_ctree_set_indent (ctree, GTK_ADJUSTMENT (widget)->value);
}

void 
change_spacing (GtkWidget * widget, GtkCTree * ctree)
{
	gtk_ctree_set_spacing (ctree, GTK_ADJUSTMENT (widget)->value);
}

void 
change_row_height (GtkWidget * widget, GtkCList * clist)
{
	gtk_clist_set_row_height (clist, GTK_ADJUSTMENT (widget)->value);
}

void 
set_background (GtkCTree * ctree, GtkCTreeNode * node, gpointer data)
{
	GtkStyle       *style = NULL;
...
void 
ctree_toggle_line_style (GtkWidget * widget, GtkCTree * ctree)
{
	gint            i;
...
void 
ctree_toggle_expander_style (GtkWidget * widget, GtkCTree * ctree)
{
	gint            i;
...
void 
ctree_toggle_justify (GtkWidget * widget, GtkCTree * ctree)
{
	gint            i;
...
void 
ctree_toggle_sel_mode (GtkWidget * widget, GtkCTree * ctree)
{
	gint            i;
...
void 
build_recursive (GtkCTree * ctree, gint cur_depth, gint depth,
...
void 
rebuild_tree (GtkWidget * widget, GtkCTree * ctree)
{
	gchar          *text[2];
	gchar           label1[] = "Root";
	gchar           label2[] = "";
